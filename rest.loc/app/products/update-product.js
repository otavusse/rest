...
$.getJSON("http://rest.loc/api/product/read_one.php?id=" + id, function(data){
...
$.getJSON("http://rest.loc/api/category/read.php", function(data){
...
$(document).on('submit', '#update-product-form', function(){
    ...
    $.ajax({
        url: "http://rest.loc/api/product/update.php",
        type : "POST",
